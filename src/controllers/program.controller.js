...
const allprogram = asyncHandler(async (req, res) => {
    ...
    res.status(200).json(new ApiResponse(200, programs, "All Programs"));
});
...
const programBasedOnDepartment = asyncHandler(async (req, res) => {
    ...
    res.status(200).json(
        new ApiResponse(200, programs, "Program in given department")
    );
});

export { allprogram, programBasedOnDepartment };
